...
import { useChatComponentEn } from "../../../hooks/useChatComponentsEn";

export const ChatsComponent: FC = () => {
  const { chatEn, parsedText } = useChatComponentEn();
  ...
  return (
    <>
      ...
      >
        {chatEn.map((chatEn) =>
          chatEn.type === "question" ? (
            <div className="chat-message" key={chatEn.text}>
